...
exports.global = {
  ...
  d: {
    ...
    segundosFormatados(seconds) {
      ...
      var message = hours == 0 ? (minutes == 0 ? `${addZero(seconds)}seg` : `${addZero(minutes)}min e ${addZero(seconds)}seg`) : `${addZero(hours)}h ${addZero(minutes)}min e ${addZero(seconds)}seg`;
