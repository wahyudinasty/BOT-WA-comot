...
English: ${data.title.english}`;
    ...
    if (g.is.body == "assalamualaikum" || g.is.body == "Assalamualaikum" || g.is.body == "Assalamu'alaikum") {
      x.reply("Wa'alaikumussalam 😃");
    } else if (g.is.body == "p" || g.is.body == "P" || g.is.body == "bot" || g.is.body == "Bot") {
      x.reply("P 👋👋");
    } else if (g.is.body.toLowerCase() == "wahyu" || g.is.body.toLowerCase() == "wayu" || g.is.body.toLowerCase() == "bang" || g.is.body.toLowerCase() == "yu" || g.is.body.toLowerCase() == "bg") {
      x.reply("Yopp 😃");
    }
